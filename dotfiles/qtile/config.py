...
keys = [
    ...
    Key([mod], "b", lazy.spawn("sh " + home + "/dotfiles/.settings/browser.sh"), desc="Launch Browseer"),
    ...
    # MY THINGS
    Key([mod], "e", lazy.spawn("sh " + home + "/dotfiles/.settings/filemanager.sh"), desc="Launch File Manager"),
    Key([mod], "m", lazy.spawn("code .config/qtile/config.py"), desc="Open Qtile Config"),
    Key([mod, "shift"], "s", lazy.spawn(home + "/dotfiles/qtile/scripts/screenshot.sh")),
